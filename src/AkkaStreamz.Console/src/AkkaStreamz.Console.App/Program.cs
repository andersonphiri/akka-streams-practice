using Akka.Hosting;
using Akka.Streams;
using AkkaStreamz.Console.App;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;


static async Task RunHosBuilders()
{
...
// await BiDirectionalFlowServerExample.Run();
// await GraphLifeCycles.Run();
// await GraphLifeCycles.SourceOfActorRef();
// contd: 57:08 duck://player/yjOQLKh81b8
// await GraphLifeCycles.UseOfKillSwitches();
// await GraphLifeCycles.UseOfPoisonPills();
// await GraphLifeCycles.GracefullyShutdownStreamInCaseOfException();
// await GraphLifeCycles.ConnectingGraphsWithActors();
await GraphLifeCycles.AskAsyncFlowToSinkActor();
